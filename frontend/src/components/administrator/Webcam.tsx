...
const Webcam: React.FC = () => {
  ...
  return (
    <div className="webcam-container">
      ...
      {/* ROS자동차에 + 웹캠 설치한것이보임  */}
      <img alt="스트리밍" src="http://192.168.137.181:8080/stream?topic=/usb_cam/image_raw" className="absolute top-0 left-0 w-full h-full object-cover" />
      ...
      {/*<img alt="스트리밍" src="http://127.0.0.1:5000/video_feed" className="absolute top-0 left-0 w-full h-full object-cover" />  웹캠*/}
