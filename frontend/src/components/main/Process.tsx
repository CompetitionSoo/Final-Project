                ...
                <h2 className="text-2xl text-center font-semibold mb-5">
                  ...
                  <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                    <ol className="list-decimal list-inside text-gray-600 space-y-6">
                      ...
                      <li>회원가입 시 입력한 정보는 MySQL 데이터베이스(DB)에 저장되며, 해당 정보를 이용해 로그인할 수 있습니다.</li>
                      <li>일반 사용자는 관리자 대시보드에 접근할 수 없으므로, 먼저 회원가입을 진행해야 합니다.</li>
                      <li>로그인하면 사용자 대시보드로 이동하며, 이후 쿠봇을 조종할 수 있는 컨트롤러 화면에 접속할 수 있습니다.</li>
                    </ol>
                  </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                  ...
                  <ol className="list-decimal list-inside text-gray-600 space-y-6">
                    <li> YOLOv8n 모델을 활용하여 과일과 채소를 인식하는 학습 모델을 제작함.</li>
