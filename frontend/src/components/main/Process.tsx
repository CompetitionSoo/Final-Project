...
const Process: React.FC = () => {
  ...
  const videoURLs = {
    idea: `${process.env.PUBLIC_URL}/videos/idea.mp4`,
    frontend: `${process.env.PUBLIC_URL}/videos/frontend.mp4`,
    ml: `${process.env.PUBLIC_URL}/videos/ml.mp4`,
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <ol className="list-decimal list-inside text-gray-600 space-y-2">
                  ...
                  <li>
                    회원가입 시 입력한 정보는 MySQL 데이터베이스(DB)에 저장되며, 해당 정보를 이용해 로그인할 수 있습니다.
                  </li>
                  <li>
                    일반 사용자는 관리자 대시보드에 접근할 수 없으므로, 먼저 회원가입을 진행해야 합니다.
                  </li>
                  <li>
                    로그인하면 사용자 대시보드로 이동하며, 이후 쿠봇을 조종할 수 있는 컨트롤러 화면에 접속할 수 있습니다.
                  </li>
                </ol>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <ol className="list-decimal list-inside text-gray-600 space-y-2">
                  ...
                  <li>
                    Yolov8n 모델을 다양한 방식으로 실험하는 과정에서 배치 사이즈, 이미지 크기 조정 및 라벨링 과정에서 일부 문제점을 발견하였으나, 수정이 미흡한 부분이 있었습니다.
                  </li>
                  <li>
                    CNN 모델을 활용해 신선도 판별을 시도했으나, 정확도가 너무 낮아 결국 폐기하였습니다.
                  </li>
                  <li>
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <ol className="list-decimal list-inside text-gray-600 space-y-4">
                  ...
                  <li>
                    초기에는 그리드 레이아웃을 사용하여 화면을 배치하였으나, 여백의 너비가 일정하게 유지되었음에도 불구하고 어색한 배치가 발생하여 BOX 형식으로 수정하였습니다.
                  </li>
                  <li>
                    자율주행 기능을 적용하여 아두이노 자동차 로봇이 검은색 선을 따라 최종 목적지까지 도달하도록 설계하였습니다.
                  </li>
                  <li>Haar Cascade 기능을 활용하여 얼굴 인식 기능을 구현하였습니다.</li>
                  <li>
                    화면 저장 기능을 추가하여, 사용자가 원하는 폴더를 생성하고 해당 위치에 이미지를 저장할 수 있도록 개발하였습니다.
                  </li>
                </ol>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2">
                ...
                <ol className="list-decimal list-inside text-gray-600 space-y-4">
                  <li>
                    아두이노 자동차 로봇을 사용하여 키보드 입력을 통해 동작과 학습 모델 적용을 확인합니다.
                  </li>
                  <li>
                    쿠봇을 통해 (ROS) 연결 후 최종적으로 원하는 기능을 수행하는지 확인합니다.
                  </li>
                </ol>
              </div>
            </div>
